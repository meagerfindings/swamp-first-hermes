...
def test_registers_only_documented_swamp_tools_and_policy_hook() -> None:
    ...
    assert [(tool["name"], tool["toolset"], tool["handler"]) for tool in context.tools] == [
        ...
        ("swamp_model_set_config", "swamp_first", swamp_model_set_config),
        ...
        ("swamp_extension_check", "swamp_first", swamp_extension_check),
        ("swamp_extension_test", "swamp_first", swamp_extension_test),
        ("swamp_extension_review_prepare", "swamp_first", swamp_extension_review_prepare),
